...
<body>
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <div class="hidden md:block w-full bg-[#003366] text-white">
            ...
            <div class="container mx-auto px-4">
                <div class="flex items-center justify-between py-4">
                    ...
                    <nav class="hidden md:flex items-center space-x-6">
                        <a href="./index.php" class="text-blue-400 font-bold  hover:text-bg-yellow-500 transition-colors">Home</a>
                    ...
                    <div class="flex items-center space-x-4">
                        <button
                            class="p-2 px-4 bg-[#003366] text-white rounded-full hover:bg-[#1A73E8]  hover:border hover:border-yellow-400 transition-colors">
